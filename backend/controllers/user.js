...
exports.editUserName = async (req, res, next) => {
  try {
    ...
    return res.status(500).json({ message: 'An error occurred while editing the user nickname' });
  }
};
...
exports.changePassword = async (req, res, next) => {
  try {
    ...
    return res.status(500).json({ message: 'An error occurred while changing the user password' });
  }
};